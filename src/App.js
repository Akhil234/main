...
const hideAll = () => {
  const newCustomer = document.getElementsByClassName("new-customer")[0];
  if (newCustomer) {
    newCustomer.style.display = "none";
  }
  
  const existingCustomer = document.getElementsByClassName("existing-customer")[0];
  if (existingCustomer) {
    existingCustomer.style.display = "none";
  }

  const existingCustomer2 = document.getElementsByClassName("existing-customer")[1];
  if (existingCustomer2) {
    existingCustomer2.style.display = "none";
  }

  const newBank = document.getElementsByClassName("new-bank")[0];
  if (newBank) {
    newBank.style.display = "none";
  }

  const existingBank = document.getElementsByClassName("existing-bank")[0];
  if (existingBank) {
    existingBank.style.display = "none";
  }

  const existingBank2 = document.getElementsByClassName("existing-bank")[1];
  if (existingBank2) {
    existingBank2.style.display = "none";
  }
